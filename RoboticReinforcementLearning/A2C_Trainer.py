...
if __name__ == "__main__":
    ...
    test_env = UnityEnvironment(file_name="../Robotic-RL-Env/Build/Robotic-RL-Env", seed=2, side_channels=[channel2])
    channel2.set_configuration_parameters(time_scale=1.0)
